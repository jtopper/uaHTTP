### uaHTTP display move menu functions ###
...
defined($form{folder})  || die "No folder passed to display_move\n";
defined($form{message}) || die "No message passed to display_move\n";
...
<form method="post" action="movemessage" name="entryForm" target="messagelist">
...
my $request = clean EDF::Object("request", \"folder_list");
...
<tr width="100%">
<td colspan="2"><div class="message">Move:<br>
<div class="vote"><table border="0" cellpadding="0" cellspacing="0">
<tr><td><input type="radio" name="option" value="1" checked></td><td>This message</td></tr>
<tr><td><input type="radio" name="option" value="2"></td><td>This message and replies</td></tr>
<tr><td><input type="radio" name="option" value="3"></td><td>Whole thread</td></tr>
<tr><td><input type="radio" name="option" value="4"></td><td>Replies only</td></tr>
</table>
<p>To: <select name="moveid">$dropdown</select></p>
</div></td>
</tr>

<tr width="100%">
<td colspan="2" class="buttonhole"><input type="submit" name="Submit" value="Execute Move" class="button"></td>
</tr>
